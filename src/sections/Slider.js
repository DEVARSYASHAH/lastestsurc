...
export default (props) => {
  ...
  const isRowBased = useMediaQuery('(min-width: 969px)');
  const styles = {
    container: isRowBased => ({
      // display: 'flex',
      // marginTop:'100px',
      marginTop:isRowBased?'0px':'200px',
        ...
        <Slider ref={sliderRef} {...settings}>
          ...
          <div className="full-width-slider__item js-slider-item" data-id={1}>
            ...
            <div style={styles.container(isRowBased)}>
              <img alt="Image" data-sizes="auto" data-srcset={slider1} src={slider1}  style={style} className="lazyload js-slider-item-image active" />
            </div>
            {/* End image */}
          ...
          <div className="full-width-slider__item js-slider-item" data-id={2}>
            {/* Image */}
            <div style={styles.container(isRowBased)}>
              <img data-id={1} alt="Image" data-sizes="auto" data-srcset={slider2} src={slider2}  style={style} className="lazyload js-slider-item-image active" />
            </div>
            {/* End image */}
            {/* Current slider number */}
